...
object PreferenceOwnership {
    val entries: List<PreferenceOwnershipEntry> = listOf(
        ...
        PreferenceOwnershipEntry("theme_dynamic_color", PreferenceOwner.MANAGER, "System dynamic color"),
        PreferenceOwnershipEntry("theme_accent_color", PreferenceOwner.MANAGER, "Theme accent color"),
        PreferenceOwnershipEntry("theme_monet_enabled", PreferenceOwner.MANAGER, "Monet palette enabled"),
        PreferenceOwnershipEntry("theme_palette_style", PreferenceOwner.MANAGER, "Monet palette style"),
        PreferenceOwnershipEntry("theme_color_spec", PreferenceOwner.MANAGER, "Monet color specification"),
        PreferenceOwnershipEntry("theme_surface_blur", PreferenceOwner.MANAGER, "Global UI surface blur"),
        PreferenceOwnershipEntry("ui_layout_scale", PreferenceOwner.MANAGER, "UI layout scale"),
        PreferenceOwnershipEntry("navigation_floating_bottom_bar", PreferenceOwner.MANAGER, "Floating navigation bar"),
        PreferenceOwnershipEntry("navigation_bottom_bar_blur", PreferenceOwner.MANAGER, "Navigation bar blur"),
        PreferenceOwnershipEntry("navigation_bottom_bar_backdrop", PreferenceOwner.MANAGER, "Navigation bar backdrop"),
        PreferenceOwnershipEntry("navigation_badges", PreferenceOwner.MANAGER, "Navigation badges"),
