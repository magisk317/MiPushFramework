...
import io.github.magisk317.mipush.core.configuration.ConfigListItem as CoreConfigListItem
import io.github.magisk317.mipush.core.configuration.ConfigSyncRecord
import io.github.magisk317.mipush.core.configuration.RemoteConfigFile
import io.github.magisk317.mipush.core.configuration.mergeConfigEntries as coreMergeConfigEntries
import io.github.magisk317.mipush.core.configuration.guessPackageConfigPath as coreGuessPackageConfigPath

/**
 * xmsf wrapper for [coreMergeConfigEntries] that accepts [LocalConfigFile] (with Android Uri)
 * and converts to [LocalConfigSummary][io.github.magisk317.mipush.core.configuration.LocalConfigSummary]
