...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--host", help="SSH host that owns the adb device, for example user@adb-host.example.")
    parser.add_argument("--jump-host", help="Optional SSH jump host, for example root@jump-host.example.")
