...
import io.github.magisk317.mipush.runtime.core.PushRuntimeBridgeHost
import io.github.magisk317.mipush.runtime.core.PushRuntimeCapabilities
import io.github.magisk317.mipush.runtime.core.PushRuntimeSnapshot

import android.content.Intent
import io.github.magisk317.mipush.protocol.model.*
import io.github.magisk317.mipush.runtime.core.*
import io.github.magisk317.mipush.push.pipeline.PushRuntimeBridge
import io.github.magisk317.mipush.push.pipeline.MiPushRuntimeBridge

object PushRuntime {
    init {
        PushRuntimeBridge.observer = object : PushRuntimeBridge.Observer {
            override fun observeChannelEvent(packageName: String?, action: String, source: String) {
                this@PushRuntime.observeChannelEvent(packageName, action, source)
            }
            override fun observeNotificationEvent(packageName: String?, action: String, source: String) {
                this@PushRuntime.observeNotificationEvent(packageName, action, source)
            }
            override fun onPayloadFromServer(context: android.content.Context, payload: ByteArray, size: Long, source: String) {
                MiPushRuntimeBridge.onPayloadFromServer(context, payload, size, source)
            }
        }
    }
    @JvmStatic
