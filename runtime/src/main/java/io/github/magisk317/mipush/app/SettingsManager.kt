...
import io.github.magisk317.mipush.runtime.db.EventDb
...
import io.github.magisk317.mipush.runtime.event.NotificationType
...
class SettingsManager @Inject constructor(
    ...
    fun notifyMockNotification(context: Context) {
        ...
        val packageName = "com.xiaomi.xmsf"
        val date = Date()
    ...
    fun shareLogs(context: Context) {
        try {
            ...
            io.github.aakira.napier.Napier.e("Failed to share logs via XMSF", e, tag = "SettingsManager")
            Toast.makeText(context, "无法启动 XMSF 日志分享: ${e.message}", Toast.LENGTH_LONG).show()
        }
    }
