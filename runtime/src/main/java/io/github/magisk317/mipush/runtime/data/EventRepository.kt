...
class EventRepository @Inject constructor(
    ...
    private val pushNavigator: PushNavigator,
) {
    ...
    constructor() : this(
        ...
        io.github.magisk317.mipush.common.utils.Singleton.instance<PushNavigator>(),
    )
    ...
    private fun getStatusDescriptionByEvent(item: Event): String {
        val container = RegSecUtils.getContainerWithRegSec(item.payload, item.regSec) as? XmPushActionContainer
        if (container != null) {
    ...
    suspend fun startConfigPreview(packageName: String) {
        pushNavigator.openConfigPreview(packageName)
    }
