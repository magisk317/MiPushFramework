...
import io.github.magisk317.mipush.protocol.model.PushConnectionState
...
class XMPushServiceLifecycleRuntime(
    ...
    fun connectionClosed(connection: Connection, reason: Int, error: Exception?) {
        ...
        XMPushServiceLifecycleBridge.onConnectionStatusChanged(ConnectionStatus.disconnected)
    ...
    fun connectionStarted(connection: Connection) {
        ...
        XMPushServiceLifecycleBridge.onConnectionStatusChanged(ConnectionStatus.connecting)
        PushRuntime.observeConnectionState(PushConnectionState.Connecting, "XMPushServiceLifecycleRuntime.connectionStarted", connection.getHost(), "listener_started")
    ...
    fun reconnectionSuccessful(connection: Connection) {
        ...
        XMPushServiceLifecycleBridge.onConnectionStatusChanged(ConnectionStatus.connected)
        ...
        PushRuntime.observeConnectionState(PushConnectionState.Connected, "XMPushServiceLifecycleRuntime.reconnectionSuccessful", connection.getHost(), "listener_connected")
