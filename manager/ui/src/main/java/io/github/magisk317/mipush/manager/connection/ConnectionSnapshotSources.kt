...
private fun ManagerConnectionSnapshotDto.toManagerConnectionSnapshot(): ManagerConnectionSnapshot =
    ManagerConnectionSnapshot(
        ...
        lastHealthCycleAtMs = lastHealthCycleAtMs,
        lastHealthCycleAction = lastHealthCycleAction,
        alarmAlive = alarmAlive,
        alarmMode = alarmMode,
        alarmFallbackReason = alarmFallbackReason,
        alarmRegisteredAtMs = alarmRegisteredAtMs,
        nextTimerAtMs = nextTimerAtMs,
        lastTimerCallbackAtMs = lastTimerCallbackAtMs,
        lastTimerCallbackDelayMs = lastTimerCallbackDelayMs,
        deviceIdleWhitelistXmsf = deviceIdleWhitelistXmsf,
        checkedPackageName = checkedPackageName,
