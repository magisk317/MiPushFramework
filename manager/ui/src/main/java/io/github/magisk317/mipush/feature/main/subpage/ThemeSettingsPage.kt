...
import io.github.magisk317.mipush.feature.ui.theme.ThemeAccent
...
fun ThemeSettingsPage(
    ...
    val selectedTheme = ThemeMode.fromValue(themeState.mode).value
    ...
    val selectedAccent = ThemeAccent.fromArgb(themeState.accentColorArgb).value
    val floatingBottomBar by viewModel.navigationFloatingBottomBar.collectAsStateWithLifecycle()
    val bottomBarBlur by viewModel.navigationBottomBarBlur.collectAsStateWithLifecycle()
    val bottomBarBackdrop by viewModel.navigationBottomBarBackdrop.collectAsStateWithLifecycle()
    val navigationBadges by viewModel.navigationBadges.collectAsStateWithLifecycle()
        ...
        SectionColumn(
            ...
            SectionCard(
                ...
                SettingsSwitchItem(
                    ...
                    viewModel.setSurfaceBlur(enabled)
                }
                SettingsSwitchItem(
            ...
            SectionCard(
                ...
                SettingsSwitchItem(
                    ...
                    viewModel.setNavigationFloatingBottomBar(enabled)
                }
                SettingsSwitchItem(
                    ...
                    viewModel.setNavigationBottomBarBlur(enabled)
                }
                SettingsSwitchItem(
                    ...
                    viewModel.setNavigationBottomBarBackdrop(enabled)
                }
                SettingsSwitchItem(
                    title = stringResource(R.string.pref_navigation_badges_title),
                    summary = stringResource(R.string.pref_navigation_badges_summary),
                    checked = navigationBadges,
                ) { enabled ->
                    viewModel.setNavigationBadges(enabled)
            }
        }
    }
    }
