...
object ManagerProtocol {
    ...
    const val WRITE_DETAIL_MOCK_REPLAY_FAILED_EVENT_NOT_FOUND = "mock_replay_failed_event_not_found"
    const val WRITE_DETAIL_MOCK_REPLAY_FAILED_PAYLOAD_MISSING = "mock_replay_failed_payload_missing"
    const val WRITE_DETAIL_MOCK_REPLAY_FAILED_SERVICE_NOT_READY = "mock_replay_failed_service_not_ready"
    const val WRITE_DETAIL_MOCK_REPLAY_FAILED_APP_NOT_INSTALLED = "mock_replay_failed_app_not_installed"
    const val WRITE_DETAIL_MOCK_REPLAY_FAILED_MISSING_REGSEC = "mock_replay_failed_missing_regsec"
    const val WRITE_DETAIL_MOCK_REPLAY_FAILED_NO_RECEIVER = "mock_replay_failed_no_receiver"
