...
data class ManagerConnectionSnapshotDto(
    ...
    override fun writeToParcel(destination: Parcel, flags: Int) {
        destination.writeWireFrame {
            ...
            writeWireBoolean(frameworkRegistered)
            writeString(timerClassName)
            writeWireBoolean(exactAlarmAvailable)
            writeWireBoolean(ignoringBatteryOptimizations)
            writeWireBoolean(deviceIdle)
            writeLong(lastHealthCycleAtMs)
            writeString(lastHealthCycleAction)
            writeWireBoolean(alarmAlive)
            ...
            writeWireBoolean(deviceIdleWhitelistXmsf)
