...
/* JADX INFO: loaded from: miuipushsdkshared_3_7_9.jar:com/xiaomi/xmpush/thrift/XmPushActionSubscriptionResult.class */
public class XmPushActionSubscriptionResult implements TBase<XmPushActionSubscriptionResult, Object>, Serializable, Cloneable {
    ...
    public int compareTo(XmPushActionSubscriptionResult xmPushActionSubscriptionResult) {
        ...
        int iCompareTo10 = Boolean.valueOf(isSetDebug()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetDebug()));
        if (iCompareTo10 != 0) {
            return iCompareTo10;
        }
        if (isSetDebug() && (iCompareTo9 = TBaseHelper.compareTo(this.debug, xmPushActionSubscriptionResult.debug)) != 0) {
            return iCompareTo9;
        }
        int iCompareTo11 = Boolean.valueOf(isSetTarget()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetTarget()));
        if (iCompareTo11 != 0) {
            return iCompareTo11;
        }
        if (isSetTarget() && (iCompareTo8 = TBaseHelper.compareTo((Comparable) this.target, (Comparable) xmPushActionSubscriptionResult.target)) != 0) {
            return iCompareTo8;
        }
        int iCompareTo12 = Boolean.valueOf(isSetId()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetId()));
        if (iCompareTo12 != 0) {
            return iCompareTo12;
        }
        if (isSetId() && (iCompareTo7 = TBaseHelper.compareTo(this.id, xmPushActionSubscriptionResult.id)) != 0) {
            return iCompareTo7;
        }
        int iCompareTo13 = Boolean.valueOf(isSetAppId()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetAppId()));
        if (iCompareTo13 != 0) {
            return iCompareTo13;
        }
        if (isSetAppId() && (iCompareTo6 = TBaseHelper.compareTo(this.appId, xmPushActionSubscriptionResult.appId)) != 0) {
            return iCompareTo6;
        }
        int iCompareTo14 = Boolean.valueOf(isSetErrorCode()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetErrorCode()));
        if (iCompareTo14 != 0) {
            return iCompareTo14;
        }
        if (isSetErrorCode() && (iCompareTo5 = TBaseHelper.compareTo(this.errorCode, xmPushActionSubscriptionResult.errorCode)) != 0) {
            return iCompareTo5;
        }
        int iCompareTo15 = Boolean.valueOf(isSetReason()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetReason()));
        if (iCompareTo15 != 0) {
            return iCompareTo15;
        }
        if (isSetReason() && (iCompareTo4 = TBaseHelper.compareTo(this.reason, xmPushActionSubscriptionResult.reason)) != 0) {
            return iCompareTo4;
        }
        int iCompareTo16 = Boolean.valueOf(isSetTopic()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetTopic()));
        if (iCompareTo16 != 0) {
            return iCompareTo16;
        }
        if (isSetTopic() && (iCompareTo3 = TBaseHelper.compareTo(this.topic, xmPushActionSubscriptionResult.topic)) != 0) {
            return iCompareTo3;
        }
        int iCompareTo17 = Boolean.valueOf(isSetPackageName()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetPackageName()));
        if (iCompareTo17 != 0) {
            return iCompareTo17;
        }
        if (isSetPackageName() && (iCompareTo2 = TBaseHelper.compareTo(this.packageName, xmPushActionSubscriptionResult.packageName)) != 0) {
            return iCompareTo2;
        }
        int iCompareTo18 = Boolean.valueOf(isSetCategory()).compareTo(Boolean.valueOf(xmPushActionSubscriptionResult.isSetCategory()));
        if (iCompareTo18 != 0) {
            return iCompareTo18;
        }
        if (!isSetCategory() || (iCompareTo = TBaseHelper.compareTo(this.category, xmPushActionSubscriptionResult.category)) == 0) {
            return 0;
        }
        return iCompareTo;
    }
    ...
    public boolean equals(XmPushActionSubscriptionResult xmPushActionSubscriptionResult) {
        ...
        boolean zIsSetDebug2 = xmPushActionSubscriptionResult.isSetDebug();
        if ((zIsSetDebug || zIsSetDebug2) && !(zIsSetDebug && zIsSetDebug2 && this.debug.equals(xmPushActionSubscriptionResult.debug))) {
            return false;
        }
        boolean zIsSetTarget = isSetTarget();
        boolean zIsSetTarget2 = xmPushActionSubscriptionResult.isSetTarget();
        if ((zIsSetTarget || zIsSetTarget2) && !(zIsSetTarget && zIsSetTarget2 && this.target.equals(xmPushActionSubscriptionResult.target))) {
            return false;
        }
        boolean zIsSetId = isSetId();
        boolean zIsSetId2 = xmPushActionSubscriptionResult.isSetId();
        if ((zIsSetId || zIsSetId2) && !(zIsSetId && zIsSetId2 && this.id.equals(xmPushActionSubscriptionResult.id))) {
            return false;
        }
        boolean zIsSetAppId = isSetAppId();
        boolean zIsSetAppId2 = xmPushActionSubscriptionResult.isSetAppId();
        if ((zIsSetAppId || zIsSetAppId2) && !(zIsSetAppId && zIsSetAppId2 && this.appId.equals(xmPushActionSubscriptionResult.appId))) {
            return false;
        }
        boolean zIsSetErrorCode = isSetErrorCode();
        boolean zIsSetErrorCode2 = xmPushActionSubscriptionResult.isSetErrorCode();
        if ((zIsSetErrorCode || zIsSetErrorCode2) && !(zIsSetErrorCode && zIsSetErrorCode2 && this.errorCode == xmPushActionSubscriptionResult.errorCode)) {
            return false;
        }
        boolean zIsSetReason = isSetReason();
        boolean zIsSetReason2 = xmPushActionSubscriptionResult.isSetReason();
        if ((zIsSetReason || zIsSetReason2) && !(zIsSetReason && zIsSetReason2 && this.reason.equals(xmPushActionSubscriptionResult.reason))) {
            return false;
        }
        boolean zIsSetTopic = isSetTopic();
        boolean zIsSetTopic2 = xmPushActionSubscriptionResult.isSetTopic();
        if ((zIsSetTopic || zIsSetTopic2) && !(zIsSetTopic && zIsSetTopic2 && this.topic.equals(xmPushActionSubscriptionResult.topic))) {
            return false;
        }
        boolean zIsSetPackageName = isSetPackageName();
        boolean zIsSetPackageName2 = xmPushActionSubscriptionResult.isSetPackageName();
        if ((zIsSetPackageName || zIsSetPackageName2) && !(zIsSetPackageName && zIsSetPackageName2 && this.packageName.equals(xmPushActionSubscriptionResult.packageName))) {
            return false;
        }
        boolean zIsSetCategory = isSetCategory();
        boolean zIsSetCategory2 = xmPushActionSubscriptionResult.isSetCategory();
        if (zIsSetCategory || zIsSetCategory2) {
            return zIsSetCategory && zIsSetCategory2 && this.category.equals(xmPushActionSubscriptionResult.category);
        }
        return true;
    }
