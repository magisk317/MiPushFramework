...
object MIPushNotificationHelper {
    ...
    @JvmStatic
    fun notifyPushMessage(context: Context, container: XmPushActionContainer, payload: ByteArray): NotifyPushMessageInfo {
        ...
        return NotifyPushMessageInfo().apply {
            ...
            try {
                ...
                MyMIPushNotificationHelper.notifyPushMessage(context, payload)
            } catch (t: Throwable) {
                MyLog.e(t)
            }
        }
