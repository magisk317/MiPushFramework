...
internal object MyMIPushNotificationIntentSupport {
    ...
    fun buildClickedPendingIntent(
        ...
        val serviceIntent = Intent().apply {
            component = ComponentName(
                ...
                if (MIPushNotificationHelper.isBusinessMessage(container)) {
                    ...
                    "io.github.magisk317.mipush.framework.sdk.MyPushMessageHandler"
                }
            )
        ...
        val configuration = io.github.magisk317.mipush.platform.support.XMPushUtils.getConfiguration(metaInfo)
    ...
    fun startServicePendingIntent(
        ...
        val localIntent = if (MIPushNotificationHelper.isBusinessMessage(container)) {
            Intent().setComponent(
                ComponentName(context.packageName, "com.xiaomi.mipush.sdk.PushMessageHandler")
            )
        } else {
