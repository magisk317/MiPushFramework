...
import io.github.magisk317.mipush.framework.hook.ExplicitHookBridge
import io.github.magisk317.mipush.framework.hook.HookTraceCompat
import io.github.magisk317.mipush.framework.pipeline.MessageIdentity
import io.github.magisk317.mipush.framework.pipeline.MiPushRuntimeBridge
import io.github.magisk317.mipush.framework.pipeline.MockMessageRegistry
...
class MyMIPushNotificationHelper {
    ...
    companion object {
        ...
        fun notifyPushMessage(context: Context, decryptedContent: ByteArray) {
            ...
            val targetPkg = MIPushNotificationHelper.getTargetPackage(container)
        ...
        private fun loadConfigurationsOnce(context: Context) {
            if (!tryLoadConfigurations) {
                ...
                try {
                    val configCenter = Global.ConfigCenter()
        ...
        private fun loadConfigurations(context: Context, configurationDirectory: Uri?) {
            ...
            configurations.init(context, configurationDirectory)
            val iconConfigurations = Global.IconConfigurations()
        ...
        /**
         * @see io.github.magisk317.mipush.framework.sdk.PushMessageProcessor#getNotificationMessageIntent
         */
        @JvmStatic
