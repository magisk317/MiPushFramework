...
include(":xmsf:shell", ":xmsf:notification", ":xmsf:push", ":mipush", ":xposed", ":common", ":core", ":settings", ":configuration", ":diagnostics", ":magisk-ui-kit", ":magisk-ui-kit:billing", ":magisk-xposed-kit", ":magisk-xposed-kit:logging", ":magisk-xposed-kit:diagnostics", ":vendor", ":pinned", ":manager:contract", ":manager:client", ":manager:ui", ":app", ":xmsf:runtime", ":xmsf:runtime:store")
