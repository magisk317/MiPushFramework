...
include(":xmsf", ":mipush", ":xposed", ":common", ":core", ":settings", ":diagnostics", ":magisk-ui-kit", ":magisk-xposed-kit", ":magisk-xposed-kit:logging", ":magisk-xposed-kit:diagnostics", ":vendor", ":pinned", ":manager", ":app")
