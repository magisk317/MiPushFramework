...
import io.github.magisk317.mipush.protocol.model.PushChannelOpenAction
import io.github.magisk317.mipush.protocol.model.PushChannelOpenPlan
import io.github.magisk317.mipush.protocol.model.PushServiceCloseAction
import io.github.magisk317.mipush.protocol.model.PushServiceResetConnectionAction
...
internal class XMPushServiceIntentDelegate(
    ...
    private fun handleUpdateChannelInfo(intent: Intent) {
        ...
        val clientInfo = client as? PushClientsManager.ClientLoginInfo
        service.runtimeObserver.onChannelEvent(clientInfo?.pkgName, action, "XMPushService.handleIntent:update_channel_info")
        if (clientInfo != null && (result.updatedClientExtra || result.updatedCloudExtra)) {
