 ...
 * JADX path: com.xiaomi.xmsf/current/base/sources/com/xiaomi/mipush/sdk/Constants.java
 * No stock 7.4.67-C same-path constants source was found in the split source tree.
 */
object Constants {
    ...
    val ASSEMBLE_PUSH_RETRY_DELAY = intArrayOf(2000, com.xiaomi.push.mpcd.Constants.MAX_CDATA_ITEM_TO_UPLOAD, 8000)
