...
public class PushMessageProcessor {
    ...
    private void ackMessage(XmPushActionContainer xmPushActionContainer) {
        ...
        PushRuntimeBridge.observeChannelEvent(xmPushActionContainer.packageName, "client_ack_sent", "PushMessageProcessor.ackMessage");
    }
    ...
    private void ackMessage(XmPushActionSendMessage xmPushActionSendMessage, XmPushActionContainer xmPushActionContainer) {
        ...
        PushRuntimeBridge.observeChannelEvent(xmPushActionContainer.packageName, "client_ack_sent", "PushMessageProcessor.ackMessageSendMessage");
    }
    ...
    private void sendAckNotification(XmPushActionNotification xmPushActionNotification) {
        ...
        PushRuntimeBridge.observeNotificationEvent(xmPushActionNotification.packageName, "clear_notification_ack_sent", "PushMessageProcessor.sendAckNotification");
    }
