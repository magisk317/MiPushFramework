...
/* JADX INFO: loaded from: miuipushsdkshared_3_7_9.jar:com/xiaomi/channel/commonutils/string/UrlBase64Coder.class */
public class UrlBase64Coder {
    ...
    public static char[] encode(byte[] bArr, int i, int i2) {
        ...
        for (int i9 = i; i9 < i7; i9 = i3) {
            ...
            cArr[i8] = cArr2[i11 >>> 2];
            int i13 = i12 + 1;
            cArr[i12] = cArr2[((i11 & 3) << 4) | (i4 >>> 4)];
            cArr[i13] = i13 < i6 ? cArr2[((i4 & 15) << 2) | (i5 >>> 6)] : '.';
            int i14 = i13 + 1;
            char c = '.';
            if (i14 < i6) {
                c = cArr2[i5 & 63];
