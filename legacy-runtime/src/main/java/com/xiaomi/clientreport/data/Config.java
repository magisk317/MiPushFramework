...
/* JADX INFO: loaded from: miuipushsdkshared_3_7_9.jar:com/xiaomi/clientreport/data/Config.class */
public class Config {
    ...
    /* JADX INFO: loaded from: miuipushsdkshared_3_7_9.jar:com/xiaomi/clientreport/data/Config$Builder.class */
    ...
    public static Config defaultConfig(Context context) {
        return getBuilder().setEventEncrypted(true).setAESKey(ClientReportUtil.getEventKeyWithDefault(context)).setMaxFileLength(1048576L).setEventUploadSwitchOpen(false).setEventUploadFrequency(86400L).setPerfUploadSwitchOpen(false).setPerfUploadFrequency(86400L).build(context);
    }
